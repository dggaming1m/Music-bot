...
BOT_TOKEN = "7979668317:AAFjiwktdh1qdi5cmInk6lircjHHVTJe4pg"  # Replace with your BOT TOKEN
...
async def promote(_, message):
    await message.reply(f"Check out our channel: {https://t.me/dg_gaming_1m0}")

@app.on_message(filters.command("autopromo"))
async def auto_promo(_, msg):
    if "join" in msg.text.lower():
        await msg.reply(f"Welcome! Subscribe to our channel: {https://t.me/dg_gaming_1m0}")
